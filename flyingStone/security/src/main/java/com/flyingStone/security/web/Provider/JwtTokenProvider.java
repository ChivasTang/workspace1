package com.flyingStone.security.web.Provider;
...
public class JwtTokenProvider {
    ...
    public String createToken(String username, List<RoleEntity> roles){
        ...
        Date now = new Date();
        //1h
        long validityInMilliseconds = 3600000L;
    ...
    public boolean validateToken(String token) {
        try{
            ...
            throw new TokenValidationException("Expired or invalid JWT token", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}
